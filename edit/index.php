...
if (isset($_FILES['profile'])) {
    move_uploaded_file(realpath($_FILES['profile']['tmp_name']), '../Images/my image.png');
}
if (isset($_FILES['icon'])) {
    move_uploaded_file(realpath($_FILES['icon']['tmp_name']), '../Images/my icon.png');
}
include("../db.php");
...
if (isset($_POST["about"])) {
    ...
    $tagline = htmlspecialchars($_POST["tagline"], ENT_QUOTES);
    $first_message = htmlspecialchars($_POST["first-message"], ENT_QUOTES);
    $second_message = htmlspecialchars($_POST["second-message"], ENT_QUOTES);
    $email = $_POST["email"];
    $phone = $_POST["phone"];
    $fb = $_POST["fb"];
    $tw = $_POST["tw"];
        ...
        <div class="row" style="background-color: #333647;">
            <div class="col-sm-3" style="border-right: #333fff solid 2px">
                <center>
                    ...
                    <img src="../Images/my image.png" style="width: 50%; padding:5px; background-color:white" alt=""><br>
                    ...
                    <img src="../Images/my icon.png" style="width: 50%; padding:5px; background-color:white" alt=""><br>
